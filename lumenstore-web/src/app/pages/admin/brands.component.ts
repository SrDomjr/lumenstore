...
import { CatalogAdminService, BrandDTO } from '../../services/catalog-admin.service';
    ...
    <div class="admin-page">
      <div class="page-panel">
        ...
        <div class="two-col-layout">
          ...
          <div class="col-form">
            <div class="form-card">
              <h3 class="form-title">Nueva marca</h3>
          ...
          <div class="col-table">
            <div class="table-card">
              <div *ngIf="loading" class="loading-state">Cargando marcas...</div>
...
export class AdminBrandsComponent implements OnInit {
  ...
  deleteItem(item: BrandDTO) {
    if (!confirm(`¿Eliminar la marca "${item.name}"?`)) return;
    this.catalogService.deleteBrand(item.id).subscribe({
      next: () => this.load(),
      error: () => alert('Error al eliminar marca'),
    });
  }
}
